...
const SobreMi = () => {
  return (
    <section className='sobremi' id='sobremi'>
      ...
      <div className="datos">
        <p><strong>Título:</strong> <strong className='tecnico'>Técnico Universitario en Desarrollo de Software</strong> en la Universidad Argentina de la Empresa UADE (2 finales restantes)</p>
